export const environment = {
  production: true,
  cas_url: 'http://cas-api.mwell',
  cas_ver: '/api/v1',
  mpi_url: 'http://mpi-api.mwell',
  mpi_ver: '/api/v1',
  doctor_url: 'http://doctor-api.mwell',
  doctor_ver: '/api/v1',
  utilities_url: 'http://utilities-api.mwell',
  utilities_ver: '/api/v1',
  forms_url: 'http://forms-api.mwell',
  forms_ver: '/api/v1',
  schedule_url: 'http:// schedule-api.mwell',
  schedule_ver: '/api/v1',
